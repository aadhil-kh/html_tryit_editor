...
This repo exists solely to track **bugs, feature requests, and user feedback** for HTML Tryit Editor. The app is a closed-source product distributed via the Microsoft Store.
...
| Documentation or help text feedback | Requests unrelated to HTML Tryit Editor |
...
- **Project type or imported file type**, if relevant
- **Screenshots, sample project files, or logs**, if applicable
...
- Whether it relates to editing, preview, console, projects, import/export, assets, mock APIs, device preview, or settings
...
| Resource | Link |
|---|---|
| Microsoft Store Listing | [HTML Tryit Editor](https://apps.microsoft.com/detail/9NZSDLLDB72Q) |
| Report an Issue | [Open an Issue](../../issues/new) |
...
The app is a proprietary, closed-source product. This repository (the issue tracker) does not contain any source code and is provided solely for community feedback and support.
